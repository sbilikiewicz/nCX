...
const char* ExInfo::query(const char *host)
{
...
int ExInfo::GetSystemTime()
{
	__int64 time = timeGetTime();
	return (time/1000)/60;
}

const char* ExInfo::RegexBuilder(const char* msg)
{
	string reg = msg;
	string regex;
