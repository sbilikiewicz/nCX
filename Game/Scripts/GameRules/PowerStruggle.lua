...
----------------------------------------------------------------------
--  GameRules.lua
--  Implementation of Power Struggle
----------------------------------------------------------------------
--  History:
--  06/2006  :  Created by Márcio Martins
...
Net.Expose {  -- CTAO NO_ATTACH is magic nigger!
			  -- Fixes server crashes caused by huge strings and floods etc.. Also much faster. Server uncrashable now!
	Class = PowerStruggle,
	ClientMethods = {
...
----------------------------------------------------------------------------------------------------
function PowerStruggle:ProcessScores(hit)
